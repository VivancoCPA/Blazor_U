...
namespace BlazorPeliculas.Servicios
{
        ...
        : IServicioGeneros
    {
        ...
        {
            using var context = dbFactory.CreateDbContext();
            var elementos = await context.Generos.OrderBy(o => o.Nombre)
                .Paginar(paginacionDTO)
                .AsNoTracking().ToListAsync();
            //AsNoTracking() es para que no se haga un seguimiento de los cambios en las entidades, lo que mejora el rendimiento cuando solo se necesitan leer datos.
