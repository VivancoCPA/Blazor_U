...
namespace BlazorPeliculas.Servicios
{
        ...
        IHttpContextAccessor httpContextAccessor) : IServicioPeliculas
    {
        ...
        public async Task Actualizar(Pelicula pelicula)
        {
            ...
            // Esto es para actualizar las propiedades de la película en la base de datos con los valores de la película que se está actualizando.
        ...
        public async Task<ResultadoPaginadoDTO<Pelicula>> Buscar(ParametrosBusquedaPeliculaDTO parametros)
        {
            ...
            // AsQueryable() es para que se pueda construir la consulta de manera dinámica, agregando condiciones según los parámetros de búsqueda.
            ...
            {
                // Esto es para filtrar las películas que tienen el género especificado en los parámetros de búsqueda.
                peliculasQueryable = peliculasQueryable
                    .Where(p =>
